                    ...
                    <form method="POST" action="{{ route('pokemon.update', $pokemon->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="number" name="number"
                                value="{{ old('number', $pokemon->number) }}">
                            @error('number')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="type_1" name="type_1"
                                value="{{ old('type_1', $pokemon->type_1) }}">
                            @error('type_1')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="type_2" name="type_2"
                                value="{{ old('type_2', $pokemon->type_2) }}">
                            @error('type_2')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="generation" name="generation"
                                value="{{ old('generation', $pokemon->generation) }}">
                            @error('generation')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="image_url" name="image_url"
                                value="{{ old('image_url', $pokemon->image_url) }}">
                            @error('image_url')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
